    ...
    <div class="musicplus">
      ...
      <div class="main_music">
        <div class="play_up">
          ...
          <div class="third_up">
            <button class="but"><a href="create.php">
              <i class="fa-solid fa-user"></i>Signup</a>
            </button>
          </div>
        </div>
        <div class="play_down">
          ...
          <div class="boxes">
            <div class="firstbox">
              ...
              <a href="create.php"><img class="firstimg" src="img/image1.webp" alt="image1"></a>
            </div>
            <div class="secondbox">
              <h5 class="up">SPATIAL AUDIO</h6>
                <h4 class="dance">Speak Now</h4>
                <h4 class="up">Apple Music R&B</h4>
                <a href="create.php"><img class="firstimg" src="img/r&b" alt="apple"></a>
            </div>
            <div class="thirdbox">
          ...
          <div class="allimage">
          <a href="create.php"><img class="images" src="img/second" alt=""></a>
          <a href="create.php"><img class="images" src="img/third" alt=""></a>
          <a href="create.php"><img class="images" src="img/myfirst" alt=""></a>
          <a href="create.php"><img class="images" src="img/forth" alt=""></a>
          <a href="create.php"><img class="images" src="img/fifth" alt=""></a>
          <a href="create.php"><img class="images" src="img/sixth" alt=""></a>
          </div>
        </div>
      </div>
    </div>
